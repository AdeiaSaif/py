...
print(f"{expenses[1]-expenses[0]} dollars I spent extra compare to January")
#     2. Find out your total expense in first quarter (first three months) of the year.
print(f"{sum(expenses[:3])} dollars are my total expense in first quarter (first three months) of the year")
